...
function insertMessage() {
  ...
  $('<div class="message message-personal">Email: ' + msg + '</div>').appendTo($('.mCSB_container')).addClass('new');
  //setDate();
...
function interact(message){
  ...
  $('<div class="message loading new"><span></span></div>').appendTo($('.mCSB_container'));
    ...
    $('<div class="message new">Response: ' + reply['text'] + '</div><br/>').appendTo($('.mCSB_container')).addClass('new');
    //setDate();
    updateScrollbar();
